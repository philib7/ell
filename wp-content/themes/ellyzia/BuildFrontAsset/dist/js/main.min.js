...
"use strict";function toggle_stock(){const t=document.getElementById("trigger-stock");t&&t.addEventListener("click",function(t){console.log("test")})}window.addEventListener("DOMContentLoaded",t=>{toggle_stock()});