...
"use strict";function toggle_stock(){const e=document.getElementById("trigger-stock");e&&e.addEventListener("click",function(e){console.log("test")})}function move_cloud(){const e=document.querySelector(".cloud1"),t=document.querySelector(".cloud2");let o=new IntersectionObserver(function(e,t){e.forEach(e=>{e.isIntersecting?e.target.classList.add("active-cloud"):e.target.classList.remove("active-cloud")})});e&&(o.observe(e),o.observe(t))}window.addEventListener("DOMContentLoaded",e=>{toggle_stock(),move_cloud()});